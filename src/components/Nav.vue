<template>
    <nav class="navbar is-info" role="navigation" aria-label="main naviation" style="min-height: 5rem;">
        <div class="navbar-brand">
            <router-link class="navbar-item is-size-4" to="/">Pedago</router-link>
        </div>
        ...
        <div id="navbar-item" class="navbar-menu">
            <div class="navbar-start">
                ...
                <router-link to="/VideoCall" class="navbar-item" v-if="this.$store.state.user.isAuthenticated">videoconference</router-link>
            </div>
