  ...
  <div class="home">
    <div class="hero is-info is-medium">
      <div class="hero-body has-text-centered">
        <h1 class="title">Welcome to Pedago</h1>
        ...
        <div class="columns is-multiline">
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 mb-4">Étudiez à votre propre rythme</h2>

              <p>Accédez à une expérience d'apprentissage flexible et étudiez à votre propre rythme</p>
            </div>
          </div>
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 mb-4">Étudiez avec d'autres apprenants</h2>

              <p>Collaborez et partagez vos connaissances avec d'autres étudiants motivés</p>
            </div>
          </div>
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 mb-4">Étudiez depuis chez vous</h2>

              <p>Étudiez depuis chez vous en toute commodité</p>
            </div>
          </div>
